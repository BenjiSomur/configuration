    ...
    <div class="container">
        <form action="<?php echo $_POST['PHP_SELF']; ?>" method="post">
            <div class="card-dashboard" style="width: 100%">
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow" style="background-color: #53565a; min-height: 230px;">
                        <a href="http://dgeu.sev.gob.mx/EEV2022.pdf" target="_blank"
                            style="text-decoration:none; width: 100%; flex-grow: 1">
                            <div class="card-body">
                    ...
                    <div class="card mb-4 box-shadow" style="background-color: #53565a">
                        <div class="card-body">
                            <button name="soleval" type="submit" style="width: 100%">
                                <h1 class="my-0 font-weight-normal card-name" style="color:#fff;">SOLICITUD DE
                                    EVALUACIÓN
                                </h1>
                    ...
                    <div class="card mb-4 box-shadow" style="background-color: #53565a">
                        <div class="card-body">
                            <button name="repinstit" type="submit" style="width: 100%">
                                <h1 class="my-0 font-weight-normal card-name" style="color:#fff;">REPORTE INSTITUCIONAL
                                </h1>
