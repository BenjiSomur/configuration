    ...
    <div class="jumbotron" style="background-color: #fff;">
        ...
        <div class="container">
            <div class="row row-buttons">
                <form action="dashboard_index.php" method="post">
                    <button id="btn-gen" class="btn btn-primary btn-lg btn-dgeu-submit"
                        style="padding: 5% 3%; max-width:90%" type="submit" name="generarsol" value="<?php $_POST['generarsol'] = "success";
                        echo htmlentities($_POST['generarsol']); ?>">
