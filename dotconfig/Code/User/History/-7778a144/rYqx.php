...
if (!file_exists("/tmp/phpstampcache")) {
    mkdir("/tmp/phpstampcache", 775);
}


$cachePath = "/tmp/phpstampcache/";
...
rrmdir("/tmp/phpstampcache");

// Envía resultado al buffer
# echo $result->output();

// Abre navegador de archivos para descargar el documento
$result->download("$name.docx");
